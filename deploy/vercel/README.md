...
cold start there. `CLAUDE.md` explicitly rules out swapping in a hosted DB
...
3. **Set the `SITE_ORIGIN` environment variable** in the Vercel project
   ...
   e.g. `https://loadbyton.vercel.app` — used to build absolute URLs in
...
- **Dashboard**: vercel.com → New Project → import `shamhar07-max/claudeloadbyton`
