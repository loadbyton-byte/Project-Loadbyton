...
export default function ForwarderClients() {
  ...
  async function fetchClients() {
    try {
      ...
      addToast(e.message || t('forwarder.errorLoad') || 'Failed to load clients', 'error');
    } finally {
      setLoading(false);
    }
  }
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      addToast(t('forwarder.added') || 'Client added to roster', 'success');
      setShowModal(false);
      setForm({ companyName: '', contactName: '', email: '', phone: '', trn: '' });
      fetchClients();
    } catch (e) {
      addToast(e.message || t('forwarder.addError') || 'Failed to add client', 'error');
    } finally {
      setSubmitting(false);
    }
  }
