    ...
    <div className="container-page max-w-5xl">
      <div className="flex items-center justify-between mb-6">
        ...
        <Button onClick={() => setShowModal(true)}>
          <IconPlus size={16} className="me-2" /> {t('forwarder.addClient', 'Add Client')}
        </Button>
      </div>
      ...
      {loading ? (
        ...
        <Card className="p-12 text-center">
          ...
          <Button onClick={() => setShowModal(true)}><IconPlus size={16} className="me-2" /> {t('forwarder.addFirstClient', 'Add First Client')}</Button>
        </Card>
      ) : (
        <>
          <div className="mb-4">
            <div className="relative max-w-md">
              ...
              <Input type="text" placeholder={t('forwarder.searchPlaceholder', 'Search clients...')} value={search} onChange={(e) => setSearch(e.target.value)} className="ps-10" />
            </div>
          </div>
