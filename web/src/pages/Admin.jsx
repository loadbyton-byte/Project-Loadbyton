  ...
  return (
    <div className="container-page py-6" dir="ltr">
      ...
      <div className="mt-6">
        ...
        {tab === 'Account approvals' && <AccountApprovalsTab />}
...
// Account approvals — the read-only gate for newly registered
// shipper/carrier accounts (see auth() in server/index.js). Separate from
// carrier document verification: every new registration starts PENDING
// here; until approved the account can browse but not act.
