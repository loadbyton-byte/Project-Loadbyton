...
const FEATURES = [
  ...
  { icon: <IconMapPin size={20} />, title: 'Live tracking & delivery commitments', body: "Every job shows its position in the lifecycle, a geofence-style pickup/delivery flag, and the carrier's committed delivery date and time." },
